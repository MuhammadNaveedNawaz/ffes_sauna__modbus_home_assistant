...
SWITCHES: tuple[FFESSaunaSwitchDescription, ...] = (
    FFESSaunaSwitchDescription(
        ...
        turn_on_fn=lambda coord: coord.write_register(REG_CONTROLLER_STATUS, STATUS_HEAT),
        turn_off_fn=lambda coord: coord.write_register(REG_CONTROLLER_STATUS, STATUS_OFF),
    ),
    FFESSaunaSwitchDescription(
        key="ventilation",
        name="Ventilation",
        ...
        turn_on_fn=lambda coord: coord.write_coil(REG_VENTILATION_STATE, True),
        turn_off_fn=lambda coord: coord.write_coil(REG_VENTILATION_STATE, False),
    ),
    FFESSaunaSwitchDescription(
        ...
        turn_on_fn=lambda coord: coord.write_coil(REG_FROST_PROTECTION, True),
        turn_off_fn=lambda coord: coord.write_coil(REG_FROST_PROTECTION, False),
    ),
    FFESSaunaSwitchDescription(
        key="infrared_mix",
        name="Infrared Mix",
        ...
        turn_on_fn=lambda coord: coord.write_coil(REG_INFRARED_MIX_STATUS, True),
        turn_off_fn=lambda coord: coord.write_coil(REG_INFRARED_MIX_STATUS, False),
    ),
)
